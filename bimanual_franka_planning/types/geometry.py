...
from bimanual_franka_planning.utils.rot_utils import matrix_to_quaternion, quaternion_to_matrix
...
class SE3Pose:
    ...
    def from_position_rpy(
        ...
        from bimanual_franka_planning.utils.rot_utils import rpy_to_matrix
    ...
    def to_rpy(self) -> tuple[float, float, float]:
        ...
        from bimanual_franka_planning.utils.rot_utils import matrix_to_rpy
