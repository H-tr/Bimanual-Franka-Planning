...
(``bimanual_franka_planning.trajectory``).  No robot URDFs or motion planner
...
pytest.importorskip("bimanual_franka_planning._time_parameterization")

from bimanual_franka_planning.trajectory import (  # noqa: E402
